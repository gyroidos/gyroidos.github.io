...
### Requirements
* A successfully built GyroidOS image file (gyroidosimage.img), either downloaded from [Github Release](https://github.com/gyroidos/gyroidos/releases/tag/v1.1) or built following the instructions [here](../build/build.md#build-gyroidos-image).
...
For instructions on how to operate GyroidOS please refer to section [Operate](../operate/control.md).
...
Signing Sub CA Key defined in [PKI](../pki.md). To obtain the image run:
```
