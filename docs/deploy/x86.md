...
<!-- [trustmeinstaller-v1.1_x86_trustx-corei7-64.img.bz2](https://github.com/gyroidos/gyroidos/releases/download/v1.1/trustmeinstaller-v1.1_x86_trustx-corei7-64.img.bz2) -->
...
### Requirements
* A successfully built GyroidOS image file (gyroidosinstaller.img), either downloaded from [Github Release](https://github.com/gyroidos/gyroidos/releases/tag/v1.1) or built following the instructions [here](../build/build.md#build-gyroidos-image).
