...
A detailed description of the container configuration can be found [here](../operate/container_config.md); the guestOS configuration is described [here](../operate/guestos_config.md).
...
This could be used to bootstrap an encrypted container, see [example: Using GuestOs debos](../operate/examples.md#example-using-guestos-debos).
...
reader device should be used (see [Container Configuration](../operate/container_config.md)), the
