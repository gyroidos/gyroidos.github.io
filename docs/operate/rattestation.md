...
Detailed instructions are available [in the deploy/qemu section](../deploy/qemu.md#use-tpm-emulation).

## QEMU

Install the required packages and create a container following [the QEMU setup instructions](../deploy/qemu.md).
