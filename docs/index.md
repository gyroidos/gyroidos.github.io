...
# GyroidOS Documentation

Welcome to the GyroidOS documentation. It collects everything needed to build,
deploy and operate GyroidOS. If you want a general introduction to the project,
see [gyroidos.io](https://www.gyroidos.io/).
